from .cassette_table_model import CassetteTableModel
from .client_status_table_model import ClientStatusTableModel
from .client_table_model import ClientTableModel
...
from .penalty_accounting_table_model import PenaltyAccountingTableModel
...
__all__ = [
    "PenaltyAccountingTableModel",
    "RentalTableModel",
    "TariffTableModel",
    "TariffTypeTableModel",
    "EmployeeTableModel",
    "PositionTableModel",
    "ClientStatusTableModel",
    "ClientTableModel",
    "FineTableModel",
    "CassetteTableModel",
    "GenreTableModel",
